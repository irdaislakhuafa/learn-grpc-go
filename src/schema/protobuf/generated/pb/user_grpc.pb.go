...
type UserServiceClient interface {
	GetUsers(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*UserResponsePagination, error)
...
func (c *userServiceClient) GetUsers(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*UserResponsePagination, error) {
...
type UserServiceServer interface {
	GetUsers(context.Context, *Empty) (*UserResponsePagination, error)
...
func (UnimplementedUserServiceServer) GetUsers(context.Context, *Empty) (*UserResponsePagination, error) {
