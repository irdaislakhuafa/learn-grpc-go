...
type AddressFunc func(context.Context, *generated.AddressMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f AddressFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.AddressMutation); ok {
		return f(ctx, mv)
	}
